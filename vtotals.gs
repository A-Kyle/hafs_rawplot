...
'set rgb '_EXLOCOL' 44 255 100';
_EXHICOL=204; _EXHIVAL=105;
'set rgb '_EXHICOL' 66 144 255';

val_i=5; val_int=10; ci=70; cf=79;
_numcols=cf-ci+1
i=ci
...
val_i=5; val_int=10; ci=100; cf=109;
_numcols=cf-ci+1
i=ci
...
title   = 'Surface wind speed [m s`a-1`n]'


*draw color bar
''src' 'bar_d' 'f_dims' -fskip 1 -direction horizontal -levcol '_cbar' -line off'
'set line 1 1 3'
'draw rec 'box_d
